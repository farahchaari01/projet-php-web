...
if(isset($_POST["btnAjouter"])){
    ...
    include "../../cnx.php";
    //création req
    $req = "INSERT INTO categories(nom,description) VALUES ('$nom','$description')";
    //exec req
    $res = $dbco->query($req);
    if($res){
...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Ajouter catégorie</h1>
    </div>
    <form action="ajoutCa.php" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-footer">
            ...
            <button type="submit" name="btnAjouter" class="btn btn-outline-primary">Ajouter</button>
        </div>
      </form>
