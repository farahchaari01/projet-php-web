...
<div class="container-fluid">
        ...
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link " aria-current="page" href="../profileAdmin.php">
              <span data-feather="home"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-lines-fill" viewBox="0 0 16 16">
  <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-5 6s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zM11 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5zm.5 2.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1h-4zm2 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2zm0 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2z"/>
          ...
          <li class="nav-item">
            <a class="nav-link " href="../produit/listeProd.php">
  ...
  <path fill-rule="evenodd" d="M10.5 3.5a2.5 2.5 0 0 0-5 0V4h5v-.5zm1 0V4H15v10a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V4h3.5v-.5a3.5 3.5 0 1 1 7 0zM8.5 8a.5.5 0 0 0-1 0v1.5H6a.5.5 0 0 0 0 1h1.5V12a.5.5 0 0 0 1 0v-1.5H10a.5.5 0 0 0 0-1H8.5V8z"/>
          ...
          <li class="nav-item">
            <a class="nav-link active" href="listeCa.php">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Liste des catégories</h1>
          <a href="ajoutCa.php" class="btn btn-outline-primary">Ajouter</a>
      </div>
    </div>
    ...
    <table class="table">
                    ...
                    $i++;
                            ...
                            <th scope ="row" >'.$i.'
                              ...
                              <td>'.$c['description'].' </td>
                              <td>
                                <a href = "modifierCaForm.php?id='.$c['id'].'"class="btn btn-success" >Modifier </a>
                                <a href ="supprimerCa.php?id='.$c['id'].'" class="btn btn-danger" >Supprimer</a>
                              </td>
                            </th>
