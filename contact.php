  ...
  <div class="site-wrap">
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="h3 mb-3 text-black">Entrez en contact</h2>
          </div>
          <div class="col-md-7">
            ...
            <form action="contact.php" method="post">
              ...
              <div class="p-3 p-lg-5 border">
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_subject" class="text-black">Produit </label>
          ...
          <div class="col-md-5 ml-auto">
            <div class="p-4 border mb-3">
              <span class="d-block text-primary h6 text-uppercase">Sfax</span>
              <p class="mb-0">Route de tunis KM1.5 IMM Affes 3002</p>
            </div>
            <div class="p-4 border mb-3">
              <span class="d-block text-primary h6 text-uppercase">Paris</span>
              <p class="mb-0">34 Rue de Tolbiac, 75013 Paris, France</p>
            </div>
            <div class="p-4 border mb-3">
              <span class="d-block text-primary h6 text-uppercase">Marrakech</span>
              <p class="mb-0">179 Rue Mohammed el Beqal, Marrakech 40000, Maroc</p>
            </div>
...
$req = "INSERT INTO contact(nom,prenom,email,produit,message) VALUES ('$nom',$prenom,'$email','$produit','$message')";
$res = $dbco->query($req);
